...
/*
    //other youtube controls extension stuff
    ...
    { // Block used to avoid setting global variables
        ...
        img.src = chrome.runtime.getURL('bookmark.png');
        let div = document.getElementsByClassName("k1zIA rSk4se");
    ...
    chrome.runtime.onMessage.addListener((obj, sender, response) => {
        ...
        console.log("content script inside of runtime on message thingy");
